    ...
    if ($result->num_rows > 0) {
        ...
        return null;
            ...
            ?>
				...
				<br><?php echo $randomImage['name']; ?><br>
                <input type="radio" name="preference<?php echo $i; ?>" value="<?php echo $randomImage['id']; ?>_1">못 먹어요
                <input type="radio" name="preference<?php echo $i; ?>" value="<?php echo $randomImage['id']; ?>_2">싫어요
                <input type="radio" name="preference<?php echo $i; ?>" value="<?php echo $randomImage['id']; ?>_3" checked>보통이에요
                <input type="radio" name="preference<?php echo $i; ?>" value="<?php echo $randomImage['id']; ?>_4">좋아요
                <input type="radio" name="preference<?php echo $i; ?>" value="<?php echo $randomImage['id']; ?>_5">매우 좋아요
                <br>
            <?php endfor; ?>
        </div><br>

        <input type="submit" onclick="submitForm()" value="확인">
